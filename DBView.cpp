...
[Function]	Insert field item to the tree control
...
[Function]	The right mouse button click event, when click on the root item, the database operation menu will be displayed.
[ReturnedValue]	void
**************************************************************/
